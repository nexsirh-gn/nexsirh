 ...
 * les bulletins source montrent deux comportements ; chaque fixture porte
 * le paramètre d'abattement qui reproduit son bulletin :
 *   - 6 salariés : abattement fixe de 150 000 GNF sur le brut
 *   - SYLLA & CAMARA : assiette = brut × 94 %
 */

export type VfAbatement =
  | { type: "fixed"; value: number }
  | { type: "percent"; value: number }; // value = % de l'assiette conservée (94)
...
export const FIXTURES_GARAYA: FixtureGaraya[] = [
  {
    ...
    vfAbatement: { type: "fixed", value: 150_000 },
  ...
  },
  {
    ...
    vfAbatement: { type: "percent", value: 94 },
